...
#оптимальное время реверберации при разных f, 125Гц 250Гц 500Гц 1000Гц 2000Гц 4000Гц
...
print("필요 흡수: ",absorption_required)
print("방안벽에 의한 총 흡수: ", absorption_total_fund)
print("사람책상등 흡수:", absorption_gon_fund)
print("문틈등 보충 흡수:", absorption_dobav_fund)
print("실제 총 흡수", absorption_res_fund)
print("모자라는 양: ", absorption_add_fund)
print(T_calculated)
